...
export class CharacterEditPage {
    ...
    protected selectTab(tab: EditTab): void {
        this.activeTab = tab;
    }
    ...
    protected saveAttributes(): void {
        if (this.characterId) this.characterService.setAttributes(this.characterId, this.attributes);
    }
    ...
    protected get combatBonusTotal(): number {
        return this.combatBonusPoints.attack + this.combatBonusPoints.defense + this.combatBonusPoints.save;
    }
    ...
    protected finish(): void {
        this.saveIdentity(); this.saveAttributes(); this.saveScores(); this.saveCollections(); this.router.navigate(['/characters']);
    }
  
    protected isSelected(set: Set<string>, id: string): boolean {
        return set.has(id);
    }
}
